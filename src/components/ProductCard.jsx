...
const ProductCard = ({
  ...
  return (
    <div
      className="relative flex min-h-[300px]  flex-col  rounded-sm transition-transform hover:scale-105  hover:shadow-sm hover:ring-1 hover:ring-black/10 hover:ring-offset-2"
