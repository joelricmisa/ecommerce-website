	...
	return (
		<div className="w-full flex flex-wrap">
			<ul className="w-full lg:w-3/12 lg:border-r flex-center gap-5 justify-start flex-wrap padding">
				{sideLinks.map((link) => (
					<li key={link.label}>
						<Link className="link font-normal lg:no-underline" to={link.href}>
							{link.label}
						</Link>
					</li>
				))}
			...
			<div className="w-full lg:w-9/12 lg:p-10 ">
				<section className=" w-full bg-black h-full lg:h-[400px]  grid-rows-2 grid-cols-2 text-white rounded-sm">
					...
					<ul className="flex-center w-full bg-black gap-2 pb-5">
